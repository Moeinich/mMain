...
import static agility.AgilityData.AgilityAreas.DRAYNOR_OBSTACLE_2;
import static agility.AgilityData.AgilityAreas.DRAYNOR_OBSTACLE_3;
import static agility.AgilityData.AgilityAreas.DRAYNOR_OBSTACLE_4;
import static agility.AgilityData.AgilityAreas.DRAYNOR_OBSTACLE_5;
import static agility.AgilityData.AgilityAreas.DRAYNOR_OBSTACLE_6;
import static agility.AgilityData.AgilityAreas.DRAYNOR_OBSTACLE_7;
...
public class DraynorCourse extends Task {
    ...
    public void ShouldRunObstacle() {
        if (PlayerHelper.withinArea(DRAYNOR_START.getArea())) {
            AgilityHelper.handleObstacle(draynor1);
        }
        else if (PlayerHelper.withinArea(DRAYNOR_TOP.getArea())) {
            if (PlayerHelper.withinArea(DRAYNOR_OBSTACLE_2.getArea())) {
                AgilityHelper.handleObstacleWithLoot(draynor2);
            }
            else if (PlayerHelper.withinArea(DRAYNOR_OBSTACLE_3.getArea())) {
                AgilityHelper.handleObstacleWithLoot(draynor3);
            }
            else if (PlayerHelper.withinArea(DRAYNOR_OBSTACLE_4.getArea())) {
                AgilityHelper.handleObstacleWithLoot(draynor4);
            }
            else if (PlayerHelper.withinArea(DRAYNOR_OBSTACLE_5.getArea())) {
                AgilityHelper.handleObstacle(draynor5);
            }
            else if (PlayerHelper.withinArea(DRAYNOR_OBSTACLE_6.getArea())) {
                AgilityHelper.handleObstacle(draynor6);
            }
            else if (PlayerHelper.withinArea(DRAYNOR_OBSTACLE_7.getArea())) {
            ...
            Movement.moveTo(DRAYNOR_START.getArea().getRandomTile());
        }
    }
}