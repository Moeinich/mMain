...
public class GnomeCourse extends Task {
    GameObject GnomeObstacle1ID = Objects.stream().within(6).id(23145).nearest().first();
    GameObject GnomeObstacle2ID = Objects.stream().within(6).id(23145).nearest().first();
    GameObject GnomeObstacle3ID = Objects.stream().within(6).id(23145).nearest().first();
    GameObject GnomeObstacle4ID = Objects.stream().within(6).id(23145).nearest().first();
    GameObject GnomeObstacle5ID = Objects.stream().within(6).id(23145).nearest().first();
    GameObject GnomeObstacle6ID = Objects.stream().within(6).id(23145).nearest().first();
    GameObject GnomeObstacle7ID = Objects.stream().within(6).id(23145).nearest().first();
